  ...
  return (
    <section className="mt-16 bg-gradient-to-br from-gray-50 via-white to-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        ...
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 h-48 bg-orange-100 rounded-full blur-3xl" />
      </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4 md:gap-6">
          {availableTypes.map((type, index) => {
            ...
            return (
              ...
              >
                <div
                  className="relative h-full bg-white rounded-2xl border border-gray-200 p-6 transition-all duration-300 hover:shadow-xl hover:-translate-y-2 hover:border-gray-300 overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3 flex flex-col gap-1">
                    {stats.trending && (
                      <div
                        className="flex items-center gap-1 px-2 py-1 rounded-full bg-red-100 text-red-600 text-xs font-medium">
                    ...
                    {stats.popular && (
                      <div
                        className="flex items-center gap-1 px-2 py-1 rounded-full bg-blue-100 text-blue-600 text-xs font-medium">
