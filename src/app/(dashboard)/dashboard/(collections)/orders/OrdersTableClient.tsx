...
import { Search, Filter, ChevronDown, X, Download, Eye, MoreHorizontal } from "lucide-react"
...
export default function OrdersTableClient({ orders }: OrdersTableClientProps) {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-white via-gray-50/50 to-white dark:from-gray-900/50 dark:via-gray-800/30 dark:to-gray-900/50 rounded-2xl border border-gray-200/60 dark:border-white/10 p-6 shadow-sm backdrop-blur-sm">
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="relative">
                            ...
                            {showStatusFilter && (
                                <div className="absolute top-full left-0 mt-2 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-white/10 rounded-lg shadow-lg z-[9999]">
                                    <div className="p-2">
                                        <button
                                            onClick={() => {
                                                setStatusFilter("")
                        ...
                        {/* Export Button */}
                        <button className="inline-flex items-center gap-2 px-4 py-2.5 bg-gray-900 text-white rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors">
            ...
            <div className="bg-white dark:bg-gray-900/50 rounded-2xl border border-gray-200/60 dark:border-white/10 shadow-sm overflow-hidden backdrop-blur-sm">
                                    ...
                                    >
                                        ...
                                        <TableCell className="px-6 py-4">
                                            <div className="flex items-center justify-end gap-2">
                                                ...
                                                <button className="inline-flex items-center justify-center w-8 h-8 rounded-lg text-gray-500 hover:text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition-all">
