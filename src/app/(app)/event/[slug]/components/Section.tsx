...
export default function Section({
    ...
    return (
        <section className="bg-white border border-gray-200 rounded-2xl px-4 md:px-8 py-8 shadow-sm hover:shadow-md transition-shadow duration-300 mb-8 relative overflow-hidden">
            {/* Subtle accent line */}
