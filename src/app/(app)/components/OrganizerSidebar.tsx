"use client"
import { Building2, MapPin, Phone, Mail, Globe, Star, Calendar, Users } from "lucide-react"
...
export default function OrganizerSidebar({
    ...
    return (
        <div className="space-y-8">
            ...
            {/* Contact Information */}
            <div className="bg-white rounded-2xl border border-gray-200 p-6 lg:p-8 shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <div className="space-y-4">
                    {contactItems.map((item, index) => {
                        ...
                        const content = (
                            <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-50 hover:bg-gray-100 transition-colors duration-200 group">
                                <div
