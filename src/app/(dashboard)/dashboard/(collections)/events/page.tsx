...
import { FaCalendarAlt, FaClock, FaMapMarkerAlt, FaEdit, FaEye, FaStar } from "react-icons/fa"
            ...
            {events.docs.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-16 px-4">
                    <div className="relative mb-6">
                        <div className="w-24 h-24 bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-2xl flex items-center justify-center">
                            <FaCalendarAlt className="text-4xl text-gray-400" />
                        </div>
                        <div className="absolute -top-1 -right-1 w-8 h-8 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {events.docs.map((event) => {
                        ...
                        return (
                            ...
                            >
                                {/* Afbeelding Sectie */}
                                <div className="relative aspect-video w-full bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-900 rounded-t-2xl overflow-hidden">
                                    {logo ? (
                                ...
                                <div className="p-5 space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {/* Extra Informatie */}
                                        <div className="flex items-center justify-between text-xs text-gray-500 dark:text-gray-400 pt-2 border-t border-gray-100 dark:border-white/10">
