...
import { CheckCircle, CreditCard, Euro, Loader2, ShoppingBag, Ticket, XCircle } from 'lucide-react'
          ...
          <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              >
                ...
                {/* Shine effect */}
                <div
                  className="absolute inset-0 opacity-0 group-hover:opacity-20 transition-opacity duration-300 rounded-xl bg-gradient-to-r from-transparent via-white to-transparent transform -skew-x-12 -translate-x-full group-hover:translate-x-full" />
              </button>
