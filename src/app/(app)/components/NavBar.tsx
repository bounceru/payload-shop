          ...
          >
            ...
            {isShop && shopName && (
              <div className="flex flex-col">
                                <span
                                  className="text-sm font-semibold text-gray-900 truncate max-w-[140px] sm:max-w-[180px]">
                                    {shopName}
                                </span>
            ...
            <nav className="flex items-center gap-1">
              {navLinks.map((link) => (
                ...
                >
                  {link.label}
                  <span
                    className="absolute inset-x-4 -bottom-px h-px bg-gradient-to-r from-transparent via-blue-500 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                </Link>
              ))}
            </nav>
            ...
            <div className="px-4 pt-4 pb-3 space-y-1">
              <form onSubmit={handleSearch} className="mb-3">
                <div className="flex flex-col gap-2">
                  ...
                  <button type="submit"
                          className="w-full flex justify-center items-center gap-2 py-2 bg-gray-100 rounded-md text-gray-700 mt-1">
                    <Search className="h-4 w-4" />
                    <span>Zoeken</span>
                  </button>
                </div>
