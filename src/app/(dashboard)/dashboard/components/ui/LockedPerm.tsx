...
export default function LockedPerm({
    ...
    return (
        <>
            ...
            >
                <LockIcon className="overflow-visible h-unset w-unset fill-gray-400 hover:fill-gray-500 disabled:hover:fill-gray-400 dark:fill-gray-400 dark:hover:fill-gray-300" />
            </button>
