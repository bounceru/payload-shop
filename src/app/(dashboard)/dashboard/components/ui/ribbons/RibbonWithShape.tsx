...
export default function RibbonWithShape() {
  return (
    <div
      ...
      <span
        className="after:bottom-0-0 absolute -left-px mt-3 inline-block bg-brand-500 px-4 py-1.5 text-sm font-medium text-white before:absolute before:-right-4 before:top-0 before:border-[13px] before:border-transparent before:border-l-brand-500 before:border-t-brand-500 before:content-[''] after:absolute after:-right-4 after:border-[13px] after:border-transparent after:border-b-brand-500 after:border-l-brand-500 after:content-['']">
        Popular
      </span>
