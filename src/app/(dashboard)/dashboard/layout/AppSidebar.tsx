...
export default function AppSidebar() {
            ...
            <li key={`${type}-${index}-${nav.name}`}>
              {hasSubItems ? (
                <>
                  ...
                  >
                    <span
                      className="flex items-center gap-3 font-medium text-sm text-gray-700 group-hover:text-gray-900">
                ...
                nav.path && (
                  ...
                  >
                    ...
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      <div
                        className="absolute inset-0 bg-gradient-to-r from-transparent via-white to-transparent opacity-10 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-700" />
                    </div>
                  </Link>
                )
              )}
  ...
  return (
    ...
    >
      ...
      {/* Resize handle */}
      <div
        className="absolute top-1/2 -right-1 w-2 h-12 bg-gray-200 rounded-r-lg opacity-0 hover:opacity-100 transition-opacity cursor-col-resize" />
    </aside>
  )
}
