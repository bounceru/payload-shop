...
import { Menu, X, LogOut, User, Settings, HelpCircle, Bell, Search, ChevronDown, Sparkles, Shield } from "lucide-react"
    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-between h-full px-4 lg:px-6">
        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <div className="hidden sm:block">
              <span className="font-bold text-lg tracking-tight drop-shadow-sm group-hover:drop-shadow-md transition-all duration-200">
                Stagepass
              </span>
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Help Button */}
          <button className="h-10 w-10 flex items-center justify-center rounded-xl bg-white/10 backdrop-blur-sm text-white hover:bg-white/20 transition-all duration-200 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-white/30">
      ...
      <div className="lg:hidden absolute top-full left-0 right-0 bg-white/95 backdrop-blur-sm border-b border-gray-200 p-4 transform -translate-y-full opacity-0 transition-all duration-300">
        <div className="relative">
          <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
