...
import type { Ticket, Addon } from "@/payload-types"
                            ...
                            {tempOrder.tickets.map((tick, idx) => {
                                if (typeof tick === "object") {
                                    ...
                                    return (
                                        ...
                                        >
                                            {/* Ticket stub design */}
                                            <div className="absolute right-0 top-0 bottom-0 w-8 bg-gray-100 border-l-2 border-dashed border-gray-300">
                                                <div className="absolute top-1/2 -translate-y-1/2 -left-2 w-4 h-4 bg-white border-2 border-dashed border-gray-300 rounded-full" />
                                            </div>
