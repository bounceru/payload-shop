    ...
    superAdminRole = await payload.create({
      ...
      data: {
        ...
        fields: [
          ...
          { collectionName: 'roles', fieldName: 'collections.collectionName', read: true, create: true, update: true, delete: true },
          { collectionName: 'roles', fieldName: 'collections.read', read: true, create: true, update: true, delete: true },
          { collectionName: 'roles', fieldName: 'collections.create', read: true, create: true, update: true, delete: true },
          { collectionName: 'roles', fieldName: 'collections.update', read: true, create: true, update: true, delete: true },
          { collectionName: 'roles', fieldName: 'collections.delete', read: true, create: true, update: true, delete: true },
          { collectionName: 'roles', fieldName: 'fields', read: true, create: true, update: true, delete: true },
          { collectionName: 'roles', fieldName: 'fields.collectionName', read: true, create: true, update: true, delete: true },
          { collectionName: 'roles', fieldName: 'fields.fieldName', read: true, create: true, update: true, delete: true },
