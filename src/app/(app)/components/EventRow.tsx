    ...
    return (
        <section className="my-20">
            ...
            {hasMore && !hideMoreButton && (
                <div className="mt-12 text-center">
                    ...
                    >
                        ...
                        {isLoading ? (
                            <div className="relative z-10 animate-spin rounded-full h-5 w-5 border-2 border-white border-t-transparent" />
                        ) : (
            ...
            {!hasMore && events.length > initialVisible && (
                <div className="mt-12 text-center">
                    <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-green-50 text-green-700 border border-green-200">
